...
(function () {
    ...
    setInterval(function() {
        observer.observe(document.querySelector(".chat-list--default"), { childList: true, subtree: true, characterData: true });
        console.log('[Twitch Chat Sound] Observing .chat-list--default');
    }, 30000);
